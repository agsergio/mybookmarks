My bookmark pages have been messy. So I created this .md to store them more efficiently.

# Miscellaneous

1. [Awesome Links](https://github.com/sindresorhus/awesome)

# Linux

1. [Linux Wiki](https://elinux.org/Main_Page)
2. [Linux Network Stack](https://maxnilz.com/docs/004-network/006-linux-rx/)
3. [Brendan Gregg's Home page](https://www.brendangregg.com/)
...
2. [System Design Interview](https://www.tryexponent.com/courses/system-design-interviews?src=nav)
...
1. [Welcome to Network World.com](<http://www.networkworld.com/>)
2.  [TechCrunch – Startup and Technology News](<https://techcrunch.com/>)
3. [The Verge](<https://www.theverge.com/>)
4. [Ars Technica](<https://arstechnica.com/>)
5. [WIRED](<https://www.wired.com/>)
6. [Blog - Radar by Qrator](<https://radar.qrator.net/blog#year2020>)
7. [InformationWeek, News & Analysis Tech Leaders Trust](<https://www.informationweek.com/>)
8. [Search Networking Information, News and Tips from TechTarget](<https://www.techtarget.com/searchnetworking/>)
9. [Light Reading](<https://www.lightreading.com/>)

# Network

## Blogs

1. [ipSpace.net by @ioshints](<https://www.ipspace.net/Main_Page>)
2. [VPackets.netCareer Archives - VPackets.net](<http://vpackets.net/category/career/>)
3. [Keeping It Classless](<https://keepingitclassless.net/>)
4. [Greg Ferro, Author at Packet Pushers](<https://packetpushers.net/author/greg-ferro/#>)
5. [Daniels Networking Blog – Networking articles by CCIE #37149/ CCDE #20160011](<https://lostintransit.se/>)
6. [History of Networking – rule 11 reader](<https://rule11.tech/history-of-networking/>)
7. [Networking with FISH : Sharing technical and non technical bits and bytes](<https://www.networkingwithfish.com/>)
8. [Software Defined Talk](<https://www.softwaredefinedtalk.com/>)
...
- [traceroute.org](<http://www.traceroute.org/#Extras>)
- [Pre-call Test](<https://tokbox.com/developer/tools/precall/>)
- [BGP Codes](<http://www.tcpipguide.com/free/t_BGPErrorReportingNotificationMessages-3.htm>)
- [Looking Glass - Hurricane Electric (AS6939)](<https://lg.he.net/>)
- [PeeringDB](<https://www.peeringdb.com/>)
- [PingOne](<https://desktop.pingone.com/equinix.com/url?source=application&url=http%3A%2F%2Fsiebelcrmsso.corp.equinix.com%2Fecommunications_open_sso%2F&title=IDP%20Connection&applicationtype=APPLICATION_DESKTOP&saasid=7b89f94b-a380-4f3b-98be-b3f4574f9680>)
- [Visualização de status | Caiu Tudo](<http://downdetector.com.br/>)
- [AS Report - Prefixos na tabela global](<http://www.cidr-report.org/cgi-bin/as-report?as=AS265864>)
